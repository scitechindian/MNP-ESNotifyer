...
class coin
{
	...
	function __construct()
	{
		...
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/32x32/crown.png';
		$cData['createAMasterNodeURL']      = 'http://crown.tech/';
		$cData['createAMasterNodeURLTitle'] = 'crown.tech';
		$cData['donate']                    = "1DRRdUoNMqjB4tro8GTH2H75T1DWC8aF9b";
		$cData['blockSeconds']              = 60;
		$cData['google']                    = "UA-102283949-15";
