...
class coin
{
	...
	function __construct()
	{
		...
		$cData['createAMasterNodeURL']      = 'http://lindacoin.com/';
		$cData['createAMasterNodeURLTitle'] = 'lindacoin.com';
		$cData['donate']                    = "LQXebHQdDVjPY3THoYwvSJGEAaRkQ5XdWN";
		$cData['blockSeconds']              = 90;
		$cData['google']                    = "UA-102283949-16";
