...
class coin
{
	...
	function __construct()
	{
		...
		$cData['masterNodeCoinRequired']    = 5000;
		$cData['walletCLI']                 = 'coinonatxd';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/coinonatx.png';
		$cData['createAMasterNodeURL']      = 'http://coinonatx.com/';
		$cData['createAMasterNodeURLTitle'] = 'coinonatx.com';
		$cData['donate']                    = "bitcoin:1NrGpJTa2BasG9J7VsgTTTF81G6htEqBC8";
		$cData['blockSeconds']              = 90;
		$cData['google']                    = 90;
		$this->coinData                     = $cData;
	}
	...
	{
		return $wallet->masternode('list','pubkey');
	}
