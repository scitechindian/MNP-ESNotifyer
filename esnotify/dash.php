...
class coin
{
	...
	function __construct()
	{
		...
		$cData['walletCLI']                 = 'dash-cli';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/dash.png';
		$cData['createAMasterNodeURL']      = 'https://www.dash.org/';
		$cData['createAMasterNodeURLTitle'] = 'DASH.org';
		$cData['donate']                    = "XqF2WcDgktmTKJ1j8Frn7AqkzfVWHZxykm";
		$cData['blockSeconds']              = 150;
		$cData['google']                    = 'UA-102283949-3';
