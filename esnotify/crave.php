...
class coin
{
	...
	function __construct()
	{
		...
		$cData['masterNodeRewardPercent']   = 66;
		$cData['masterNodeCoinRequired']    = 500;
		$cData['walletCLI']                 = 'craved';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/crave.png';
		$cData['createAMasterNodeURL']      = 'https://www.craveproject.com/masternodes/index.html';
		$cData['createAMasterNodeURLTitle'] = 'craveproject.com';
		$cData['donate']                    = "C1sAKFqjdHMmrMVvJ6hJfFwqNpGEPpNh6P";
		$cData['blockSeconds']              = 60;
		$cData['google']                    = 'UA-102283949-8';
