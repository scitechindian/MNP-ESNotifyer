...
class coin
{
	...
	function __construct()
	{
		...
		$cData['masterNodeRewardPercent']   = 85;
		$cData['masterNodeCoinRequired']    = 50000;
		$cData['walletCLI']                 = 'vsync-cli';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/insanecoin-insn.png';
		$cData['createAMasterNodeURL']      = 'http://www.insanecoin.com/';
		$cData['createAMasterNodeURLTitle'] = 'insanecoin.com';
		$cData['donate']                    = "bitcoin:1NrGpJTa2BasG9J7VsgTTTF81G6htEqBC8";
		$cData['blockSeconds']              = 300;
		$cData['google']                    = 90;
		$this->coinData                     = $cData;
	}
