...
class coin
{
	...
	function __construct()
	{
		...
		$cData['masterNodeRewardPercent']   = 20;
		$cData['masterNodeCoinRequired']    = 100000;
		$cData['walletCLI']                 = 'creamd';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/cream.png';
		$cData['createAMasterNodeURL']      = 'https://creamcoin.com';
		$cData['createAMasterNodeURLTitle'] = 'creamcoin.com';
		$cData['donate']                    = "CLxfxxzWPASYi94y4JoRjyPRHuAL6rrRfM";
		$cData['blockSeconds']              = 240;
		$cData['google']                    = 90;
		$this->coinData                     = $cData;
	}
