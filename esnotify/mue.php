...
class coin
{
	...
	function __construct()
	{
		...
		$cData['masterNodeCoinRequired']    = 500000;
		$cData['walletCLI']                 = 'chaincoind';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/monetaryunit.png';
		$cData['createAMasterNodeURL']      = 'https://www.monetaryunit.org/';
		$cData['createAMasterNodeURLTitle'] = 'monetaryunit.org';
		$cData['donate']                    = "7nd7MNdMaxHdgw6zet1CMmu17feBo64yBo";
		$cData['blockSeconds']              = 40;
		$cData['google']                    = "UA-102283949-7";
