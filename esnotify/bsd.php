...
class coin
{
	...
	function __construct()
	{
		...
		$cData['createAMasterNodeURL']      = 'http://www.bitsend.info/';
		$cData['createAMasterNodeURLTitle'] = 'bitsend.info';
		$cData['donate']                    = "i55ZTLvz3q49CU7WrMHQBgbM2V4PY7JwRS";
		$cData['blockSeconds']              = 180;
		$cData['google']                    = "UA-102283949-111";
