...
class coin
{
	...
	function __construct()
	{
		...
		$cData['walletCLI']                 = 'digitalpriced';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/digitalprice.png';
		$cData['createAMasterNodeURL']      = 'http://digitalprice.org/';
		$cData['createAMasterNodeURLTitle'] = 'digitalprice.org';
		$cData['donate']                    = "bitcoin:1NrGpJTa2BasG9J7VsgTTTF81G6htEqBC8";
		$cData['blockSeconds']              = 120;
		$cData['google']                    = 90;
		$this->coinData                     = $cData;
	}
