...
class coin
{
	...
	function __construct()
	{
		...
		$cData['walletCLI']                 = 'das-cli';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/das.png';
		$cData['createAMasterNodeURL']      = 'https://www.dascrypto.com/';
		$cData['createAMasterNodeURLTitle'] = 'dascrypto.com';
		$cData['donate']                    = "DUPvQG5cw4p37S9oc9DZYXQrkzFbjR6gE3";
		$cData['blockSeconds']              = 150;
		$cData['google']                    = "UA-102283949-17";
