...
class coin
{
	...
	function __construct()
	{
		...
		$cData['walletCLI']                 = 'monacoCoin-cli';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/monacocoin.png';
		$cData['createAMasterNodeURL']      = 'http://www.monacocoin.net/';
		$cData['createAMasterNodeURLTitle'] = 'monacocoin.net';
	...
	private function reward($height)
	{
		if ($height <= 270000) {
			...
			$ret['reward']     = 10;
			$ret['nextreward'] = 5;
		} elseif ($height <= 532800) {
			$ret['height']     = 568622;
			$ret['reward']     = 5;
			$ret['nextreward'] = 3;
		} elseif ($height <= 1058400) {
			$ret['height']     = 1012098;
			$ret['reward']     = 3;
			$ret['nextreward'] = 2;
		} else {
