...
class coin
{
	...
	function __construct()
	{
		...
		$cData['walletCLI']                 = 'Neutrond';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/neutron.png';
		$cData['createAMasterNodeURL']      = 'https://www.neutroncoin.com/';
