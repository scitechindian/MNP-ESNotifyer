...
class coin
{
	...
	function __construct()
	{
		...
		$cData['walletCLI']                 = 'eternity-cli';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/32x32/eternity.png';
		$cData['createAMasterNodeURL']      = 'http://ent.eternity-group.org/';
		$cData['createAMasterNodeURLTitle'] = 'ent.eternity-group.org';
		$cData['donate']                    = "1AYcZq9qcNcF5yaBb1jWsLn9KSF2UDAJzq";
		$cData['blockSeconds']              = 150;
		$cData['google']                    = "UA-102283949-10";
	...
	{
		return $wallet->eternitynodelist('full');
	}
