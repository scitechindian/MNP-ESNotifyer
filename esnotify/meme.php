...
class coin
{
	...
	function __construct()
	{
		...
		$cData['masterNodeCoinRequired']    = 20000;
		$cData['walletCLI']                 = 'iond';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/ion.png';
		$cData['createAMasterNodeURL']      = 'https://ionomy.com';
		$cData['createAMasterNodeURLTitle'] = 'ionomy.com';
		$cData['donate']                    = "icUZiVjSaSyJx4oz9oBD4RqmHfmFYoDSBF";
		$cData['blockSeconds']              = 64;
		$cData['google']                    = 90;
