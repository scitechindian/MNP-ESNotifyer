...
class coin
{
	...
	function __construct()
	{
		...
		$cData['masterNodeCoinRequired']    = 30000;
		$cData['walletCLI']                 = 'renosd';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/32x32/renos.png';
		$cData['createAMasterNodeURL']      = 'https://renoscoin.com/';
		$cData['createAMasterNodeURLTitle'] = 'renoscoin.com';
		$cData['donate']                    = "RFcMjvbxLBxmfwaME4x4uMLCxvXpWpgtnY";
