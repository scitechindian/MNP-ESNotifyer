...
class coin
{
	...
	function __construct()
	{
		...
		$cData['masterNodeRewardPercent']   = 45;
		$cData['masterNodeCoinRequired']    = 1000;
		$cData['walletCLI']                 = 'arcticcoin-cli';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/arcticcoin.png';
		$cData['createAMasterNodeURL']      = 'http://www.arcticcoin.org/';
		$cData['createAMasterNodeURLTitle'] = 'arcticcoin.org';
		$cData['donate']                    = "AYHcfiHmhhBkBAWJSE5ewTDxJzXax5CD1Q";
		$cData['blockSeconds']              = 150;
		$cData['google']                    = 'UA-102283949-5';
	...
	private function getCoinMarketCapData($es)
	{
		...
		$search['size']                           = '1';
		$search['sort'][0]['lastUpdate']['order'] = 'desc';
	...
	{
		return $wallet->goldminenodelist('full');
	}
