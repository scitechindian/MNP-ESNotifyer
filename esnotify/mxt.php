...
class coin
{
	...
	function __construct()
	{
		...
		$cData['walletCLI']                 = 'MarteXd';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/martexcoin.png';
		$cData['createAMasterNodeURL']      = 'http://martexcoin.org/';
		$cData['createAMasterNodeURLTitle'] = 'martexcoin.org';
