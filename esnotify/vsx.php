...
class coin
{
	...
	function __construct()
	{
		...
		$cData['masterNodeCoinRequired']    = 250000;
		$cData['walletCLI']                 = 'vsync-cli';
		$cData['logo']                      = 'https://files.coinmarketcap.com/static/img/coins/128x128/vsync.png';
		$cData['createAMasterNodeURL']      = 'https://vsync.pw/';
		$cData['createAMasterNodeURLTitle'] = 'vsync.pw';
